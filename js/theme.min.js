!function (e) {
        ...
        return n(e, [{
            ...
            key: "_updateQuantity", value: function (e, t) {
                ...
                if (t.getAttribute("data-line") !== null) {
                    // Use a propriedade "line" no corpo da solicita̤̣o fetch
                    var requestBody = {
                        line: t.getAttribute("data-line"),
                        quantity: n
                    };
                } else {
                    // Use a propriedade "id" no corpo da solicita̤̣o fetch
                    var requestBody = {
    ...
    var T = function () {
        ...
        return n(e, [{
            ...
            key: "_renderAvailabilitySection", value: function (e) {
                ...
                return i && i.remove(), fetch("".concat(window.routes.rootUrlWithoutSlash, "../variants/index.html").concat(e, "?section_id=store-availability")).then(function (i) {
        ...
        function e(i) {
            ...
            n.rel = "stylesheet", n.href = "../../cdn.shopify.com/shopifycloud/model-viewer-ui/assets/v1.0/model-viewer-ui.css", document.head.appendChild(n), window.Shopify.loadFeatures([{
        ...
        function e(i, n) {
            switch (t(this, e), this.element = i, this.delegateElement = new d(this.element), this.enableVideoLooping = n, this.player = null, this.element.getAttribute("data-media-type")) {
                case"video":
                    ...
                    s.rel = "stylesheet", s.href = "../../cdn.shopify.com/shopifycloud/shopify-plyr/v1.0/shopify-plyr.css", document.head.appendChild(s), window.Shopify.loadFeatures([{
                        name: "video-ui",
                        version: "1.0",
        ...
        return n(e, [{
            ...
            key: "_loadYouTubeScript", value: function () {
                return new Promise(function (e, t) {
                    ...
                    document.body.appendChild(i), i.onload = e, i.onerror = t, i.async = !0, i.src = "http://www.youtube.com/iframe_api"
                })
            }
        },]), e
    }(), M = c(function (e) {
    ...
    var eh, ed, eu = function () {
            ...
            return n(e, [{
                ...
                key: "_updateCartCookie", value: function (e) {
                    var t = new Date;
                    t.setTime(t.getTime() + 12096e5), document.cookie = "cart=".concat(e, "; expires=").concat(t.toUTCString(), "%3b%20path%3d/index.html")
                }
            },]), e
        }(), em = function () {
            function e(i) {
            ...
            return n(e, [{
                ...
                key: "_saveNote", value: function () {
                    ...
                    fetch("".concat(window.routes.cartUrl, "../update.html"), {
            ...
            function e(i) {
                t(this, e), this.element = i, this.delegateElement = new d(this.element), this.options = JSON.parse(this.element.getAttribute("data-section-settings")), this.collectionFilterTagElements = this.element.querySelectorAll("[data-tag]"), this.currentUrl = new URL(window.location.html), this.currentTags = this.options.currentTags, Shopify.designMode && window.SPR && (window.SPR.initDomEls(), window.SPR.loadBadges()), this.mobileFilterDrawer = new g(this.options), this.displayByValuePicker = new em("display-by-selector", {onValueSelect: this._showingCountChanged.bind(this)}), this.sortByValuePicker = new em("sort-by-selector", {onValueSelect: this._sortByChanged.bind(this)}), this.productItemColorSwatch = new L(this.element), "search" === window.theme.pageType && "product" !== window.theme.searchMode && this._loadContentResults(), this._attachListeners()
            }
            ...
            return n(e, [{
                ...
                key: "_attachListeners", value: function () {
                    ...
                    this.delegateElement.on("click", '[data-action="change-layout"]', this._changeLayout.bind(this)), this.delegateElement.on("change", "#mobile-sort-by, #desktop-sort-by", this._sortByChanged.bind(this)), this.delegateElement.on("change", "#showing-count", this._showingCountChanged.bind(this)), this.delegateElement.on("click", ".pagination [data-page]", this._paginationPageChanged.bind(this)), this.delegateElement.on("click", '[data-action="toggle-tag"]', this._tagToggled.bind(this)), this.delegateElement.on("click", '[data-action="clear-tags"]', this._clearTags.bind(this)), this.delegateElement.on("click", '[data-secondary-action="open-quick-view"]', this._openQuickView.bind(this)), this.delegateElement.on("click", '[data-action="add-to-cart"]', this._addToCart.bind(this)), window.addEventListener("popstate", function (t) {
                        t.state.path && (e.currentUrl = new URL(t.state.html), e._reload(!1))
                    })
                }
            }, {
                key: "_openQuickView", value: function (e, t) {
                ...
                key: "_showingCountChanged", value: function (e) {
                    var t = this;
                    this.currentUrl.searchParams.delete("page"), fetch("".concat(window.routes.cartUrl, "../update.html"), {
                ...
                key: "_updateTagUrl", value: function (e) {
                    ...
                    if (v.mutate(function () {
                        ...
                        if (e) {
                            var s = n.split("../index.html");
                            s.pop(), this.currentUrl.pathname = "".concat(s.join("../index.html"), "../index.html").concat(i)
                        } else this.currentUrl.pathname = "".concat(n, "../index.html").concat(i)
                    }
                }
            }, {
                key: "_reload", value: function (e) {
                    ...
                    return fetch(n = this.currentUrl.search ? "".concat(this.currentUrl.pathname, "../index.html").concat(this.currentUrl.search, "&section_id=").concat(this.element.getAttribute("data-section-id")) : "".concat(this.currentUrl.pathname, "?section_id=").concat(this.element.getAttribute("data-section-id")), {
                        credentials: "same-origin",
                        method: "GET"
                    }).then(function (e) {
                        e.text().then(function (e) {
                ...
                key: "_loadContentResults", value: function () {
                    var e = this, t = new URL(window.location.html);
                ...
                polyfill: function () {
                    ...
                    if (!("scrollBehavior" in i.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
                        var n, s = t.HTMLElement || t.Element, o = 468, a = {
                            ...
                            l = (n = t.navigator.userAgent, RegExp("MSIE%20_Trident/_Edge/index.html").test(n) ? 1 : 0);
    ...
    c(function (t) {
        ...
        if ("fetch" in window && "assign" in Object) e(); else {
            ...
            t.src = "../../cdn.polyfill.io/v3/polyfill.mindc21.js?unknown=polyfill&amp;features=fetch,Element.prototype.closest,Element.prototype.matches,Element.prototype.remove,Element.prototype.classList,Array.prototype.includes,String.prototype.includes,Object.assign,CustomEvent,URL,DOMTokenList", t.async = !1, t.onload = function () {
                e()
